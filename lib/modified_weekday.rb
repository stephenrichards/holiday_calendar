# This class encapsulates all the information needed to describe
# something like first monday, second thursday or last wednesday of a
# particular month.
...
class ModifiedWeekday
  ...
  # Instantiate a ModifiedWeekday object from either an expression
  # such as :first_monday, or a date object
  #
  # params
  # * param : param can either be a valid expression or a date object.
  # * valid expressions are :xxxx_yyyyyy where xxxx is :first,
  #                         :second, :third, :fourth, :last and yyyy
  ...
  # Compare two ModifiedWeekday objects.  Objects are equal if the
  # expression is the same, or the days are the same and the modifier
  # is :last and / or is_last is true.
  def ==(other)
