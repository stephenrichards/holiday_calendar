# Encapsulates a date which is a public holiday for a particular year
# derived from a PublicHolidaySpecification and a year
...
class PublicHoliday
  ...
  #
  # params
  # * public_holiday_specification: a PublicHolidaySpecification
  #                                 object
  # * year: a year number
  #
  ...
  # returns the date and name of the holiday, and optionally, the date
  # adjustedtext if any.
  ...
  # returns true if the day number of the holiday date is in the
  # taken_before array
  ...
  # generates an actual date for @year from the
  # PublicHolidaySpecification when the specification is written as an
  # expression
  ...
  # returns the date of the nth monday, tuesday, etc. in a month for a
  # particular year
  #
  # params
  # * year: the year for which the date is to be generated
  # * month: the month number (1-12) for which the date is to be generated
  # * wday: the wday number (Sunday = 0, Saturday = 6) for which the
  #          date is to be generated
