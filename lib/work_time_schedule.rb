class WorkTimeSchedule
  ...
  # Instantiates a WorkTimeSchedule object using the named
  # HolidayCalendar object, and the default start and end times of the
  # working day.
  #
  # Parameters:
  ...
  ############# this needs to be thoroughly testeed, including times both in and out of hours, etc
